...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Tomatoes_App</application>
    ...
    <classAccesses>
        <apexClass>TomatoesService</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TomatoesService_Test</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Tomatoes_API_Settings__mdt.access_token__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Tomatoes_API_Settings__mdt.provider__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>User.Tomatoes_API_access_token__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>User.Tomatoes_API_provider__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Tomatoes_API_Settings__mdt-Tomatoes API Settings Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <objectPermissions>
        ...
        <object>Tomatoes_API_Settings__mdt</object>
    ...
    <tabVisibilities>
        <tab>Tomatoes_List</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
        <tab>Tomatoes_Settings</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
